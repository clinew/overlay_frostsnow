...
PATCHES=(
	...
	"${FILESDIR}"/v4-0002-Add-logging-for-OpenSSL-connections.patch
	"${FILESDIR}"/v4-0003-Add-OpenSSL-rehash-messages.patch
	"${FILESDIR}"/v4-0004-m_ssl_openssl-Add-strong-peer-cert-validation.patch
	"${FILESDIR}"/v4-0005-Warn-on-old-client-certificate.patch
	"${FILESDIR}"/v4-0006-CotSS-configuration.patch
)
